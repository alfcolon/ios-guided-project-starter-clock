...
@IBDesignable //updates storyboard in realtime
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            // clock face
            context.addEllipse(in: rect) // draw circle
            context.setFillColor(clockBgColor.cgColor) //fill it
            context.fillPath()
            ...
            // numerals //places numbers on clock
